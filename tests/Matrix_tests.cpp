...
TEST_CASE("test matrix konstruktor parametryczny"){
    ...
    double tabm1[2][2] = {{1,3},{2,4}}, tabm2[2][2] = {{1,3}, {2,4}};
    Matrix m1(tabm1);
    Matrix m2(tabm2);
    CHECK(m1 == m2);
}
TEST_CASE("test matrix konstruktor bezparametryczny"){
    ...
    double tab3[2][2] = {{0,0}, {0,0}};
    Matrix m1(tab3), m2;
    CHECK(m2 == m1);
}
TEST_CASE("test matrix mnozenie razy wektor (z prawej strony)"){

    double tab1[2] = {1, 3},  tab2[2] = {2, 4}, tabm1[2][2] = {{1,2}, {3,4}}, tabres[2] = {7, 15};
    Matrix m1(tabm1);
...
{
    double tab1[2] = {1, 3}, tab2[2] = {1, 4}, tab3[2] = {2, 3}, tab4[2] = {2, 4}, tabm1[2][2] = {{1,2}, {3,4}};
    Matrix m1(tabm1);
...
{
    double tabm1[2][2] = {{2, 3}, {1, 4}}, tabm2[2][2] = {{0,-1}, {1, 0}};
